...
export function AppSidebar({
  ...
  // Check server health - wrapped in useCallback to fix dependency warning
  ...
  }, [isSignedIn, token, checkServerHealth])
  ...
  // Fetch chat history - wrapped in useCallback to fix dependency warning
  const fetchChatHistory = useCallback(async (page = 1, size = pageSize, isRefresh = false) => {
  ...
  }, [token, isSignedIn, connectionStatus, apiBaseUrl, pageSize])
  ...
  }, [isSignedIn, token, connectionStatus, fetchChatHistory])
