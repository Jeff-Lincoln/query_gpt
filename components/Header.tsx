...
// import { SignedIn, SignedOut, SignInButton, SignUpButton, UserButton, useUser } from '@clerk/nextjs'
// import { ChevronLeftIcon, LogIn, MenuIcon, MessageCircle, UserPlus } from 'lucide-react'
// import Link from 'next/link'
...
//   const { toggleSidebar, isMobile, open } = useSidebar();
//   return (
//           <header className="fixed top-0 w-full z-50 bg-black/20 backdrop-blur-lg border-b border-purple-700/10
//           flex items-center justify-between border-b-1 border-purple-700">
...
//                 {/* Navigation Links - Hidden on signed out landing page */}
//                 <SignedIn>
...
//                         elements: {
//                           avatarBox: "w-8 h-8",
//                           userButtonPopoverCard: "bg-white/95 backdrop-blur-lg",
//                           userButtonPopoverActions: "bg-white/95"
//                         }
//                       }}
//                       showName
